...
import { ArrowLeftCircle, Upload, X, FileText, AlertCircle, CheckCircle } from "lucide-react";
import { createAssessment, CreateAssessmentData } from "@/services/assessmentService";
import dynamic from "next/dynamic";
import { isPdfFile, extractTextFromPdf } from "@/utils/pdfUtils"; // Static import restored here

// Dynamically import FloatingIcons with ssr: false - This is fine as it's separate
const FloatingIcons = dynamic(() => import("@/components/app/FloatingIcons"), { ssr: false });

// The AssessmentForm component, now in its own file
export default function AssessmentForm() {
  ...
  const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const text = await extractTextFromPdf(file); // Using static import again
            ...
            <div className="space-y-6">
              ...
              <div className="pt-4">
                <button
                  ...
                  type="submit"
                  disabled={isSubmitting || !title || !description || isExtracting || (courseMaterial !== null && (!fileValid || !extractedText))} // Reverted the !pdfUtils check
                >
